...
if __name__ == "__main__":
    ...
    parser.add_argument('--action', choices=['empty', 'find', 'replace'], required=True,
                        help='Action: empty (list empty types), find (find by type), replace (replace type)')
    ...
    parser.add_argument('--dry-run', action='store_true',
                        help='Dry run mode (replace only: analyze without making changes)')
